		...
		return (
			<>
				<Container maxWidth="md" style={{ height: '100vh', overflow: 'auto' }}>
					<h1 style={{ textAlign: 'center' }}>Termes of Service</h1>
					<Grid container>
						...
						<p>&nbsp;</p>
						<p>
							This website is operated by xD33m. Throughout the site, the
							terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo;
							refer to xD33m. xD33m offers this browser-extension, including
							all information, tools and services available from this
							site/browser-extension to you, the user, conditioned upon your
						...
						<p>
							...
							engage in our &ldquo;Service&rdquo; and agree to be bound by
							the following terms and conditions (&ldquo;Terms of
							Service&rdquo;, &ldquo;Terms&rdquo;), including those
							additional terms and conditions and policies referenced herein
							and/or available by hyperlink. These Terms of Service apply
						...
						<p>&nbsp;</p>
						<p>
							In no case shall xD33m, our directors, officers, employees,
						...
						<p>&nbsp;</p>
						<p>
							You agree to indemnify, defend and hold harmless xD33m and our
						...
						<p>
							...
							accordance with the laws of Lange Stra&szlig;e 24,
							Filderstadt, BW, 70794, Germany.
						</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
